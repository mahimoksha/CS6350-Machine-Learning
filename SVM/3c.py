...
for C in C_val:
    for g in gamma:
        ...
        support_vectors_common.append(X_train[indices_for_support])
...
print("The number of overlapped support vectors between gamma values 0.01 and 0.1 are {}".format(len(set(support_vectors_common_indices[0])&set(support_vectors_common_indices[1]))))


# In[79]:


print("The number of overlapped support vectors between gamma values 0.1 and 0.5 are {}".format(len(set(support_vectors_common_indices[1])&set(support_vectors_common_indices[2]))))
